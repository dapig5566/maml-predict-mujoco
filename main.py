...
flags.DEFINE_integer("meta_batch_size", 32, "the meta batch size.")
...
flags.DEFINE_integer("value_iterations", 256, "the number of transitions in context encoder.")
flags.DEFINE_integer("hidden_dim", 32, "the number of transitions in context encoder.")
flags.DEFINE_float("reward_scale", 4., "reward scale.")
...
flags.DEFINE_float("info_bottleneck_coeff", 0.2, "the coefficient of information bottleneck term.")
